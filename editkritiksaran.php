...
if( !isset($_GET['kd_kritik']) ){
    header('Location: ./datakritiksaran.php');
}

//ambil id dari query string
$kd_kritik = $_GET['kd_kritik'];

// buat query untuk ambil data dari database
//$query = "SELECT * FROM kritiksaran WHERE kd_kritik=$data";
$mysql_query = mysqli_query($host, "SELECT * FROM kritiksaran WHERE kd_kritik='$kd_kritik'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Kritik dan Saran
        <small>Edit  Kritik dan Saran</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="berita.html"><i class="treeview-menu"></i> Kritik dan Saran</a></li>
        <li class="active">Edit  Kritik dan Saran</li>
      </ol>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseseditkritiksaran.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                    <input type="text" class="form-control hidden" name="kd_kritik" value="<?php echo $data['kd_kritik']; ?>">
                      </div>
                      <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" class="form-control" name="kd_anggota"value="<?php echo $data['kd_anggota'];?>">
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kritiksaran" value="<?php echo $data['kritiksaran'];?>">
                      <p class="help-block">Data sudah di edit?</p>
