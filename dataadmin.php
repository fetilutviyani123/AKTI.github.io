  ...
  <div class="content-wrapper">
    ...
    <div class="box-body with-border">
      <div class="pull-right">
        <a href="tambahadmin.php" class="btn btn default btn-xs"><i class="glyphicon glyphicon-refresh">Tambah Admin</i></a>
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-border table-hover" name="kd_admin">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Admin</th>
                ...
                <?php
                    ...
                    <tr>
                      ...
                      <td><?=$data['kd_laporan']?></td>
                      <td>
                        <a href="deladmin.php?kd_admin=<?= $data['kd_admin'] ?>" class="btn btn-danger btn-xs" onclick="return confrim('data yang dipilih akan terhapus')"> <i class="glyphicon glyphicon-trash"></i></a>
                      </td>
                      <td>
                        <a href="editadmin.php?kd_admin=<?= $data['kd_admin'] ?>" class="btn btn-warning btn-xs" onclick="return confrim('data yang dipilih akan diedit')"> <i class="glyphicon glyphicon-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                    }
