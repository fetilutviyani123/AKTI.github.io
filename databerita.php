  ...
  <div class="content-wrapper">
    ...
    <div class="box-body with-border">
      <div class="pull-right">
        <a href="tambahberita.php" class="btn btn default btn-xs"><i class="glyphicon glyphicon-refresh">Tambah Berita</i></a>
      </div>
        ...
        <tbody>
          <?php
              ...
              <tr>
                ...
                <td style="width:150px;"><img  style="width:150px;" src="/akti/img/<?=$data['gambar']?>" alt=""></td>
                <td>
                  <a href="delberita.php?kd_berita=<?= $data['kd_berita'] ?>" class="btn btn-danger btn-xs" onclick="return confrim('data yang dipilih akan terhapus')"> <i class="glyphicon glyphicon-trash"></i></a>
                </td>
                <td>
                  <a href="editberita.php?kd_berita=<?= $data['kd_berita'] ?>" class="btn btn-warning btn-xs" onclick="return confrim('data yang dipilih akan diedit')"> <i class="glyphicon glyphicon-edit"></i></a>
                </td>
              </tr>
              <?php
              }
