...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="/AKTI/pages/examples/register.php">
              <span class="label label-success"> Daftar</span>
            </a>
            
          <!--login-->
          <li>
            <a href="/AKTI/pages/examples/login.php">
      ...
      <div class="user-panel">
        <div class="pull-left image">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <a href="https://www.youtube.com/channel/UCk9cB78EFjvE7dWQzIthP-Q/featured">
                  <span class="header text-white" style="color:white">Aliansi Kungfu<br>Tradisional Indonesia</span> </a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <li><a href="berita.php"><i class="fa fa-edit"></i>Baca Berita</a></li>
            ...
            <li><a href="databerita.php"><i class="fa fa-edit"></i>Data Berita</a></li>ss
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="index.html"><i class="fa fa-dashboard"></i> Home</li>
        <li class="active">Kritik dan Saran</a></li>
      </ol>
    </section>
    ...
    <div class="box box-info">
      <div class="box-header">
        ...
        <h3 class="box-title">AKTI</h3>
        <!-- tools box -->
        <div class="">
        </div>
    <div class="box-body with-border">
      <div class="pull-right">
        <a href="kritiksaran.php" class="btn btn default btn-xs"><i class="glyphicon glyphicon-refresh">Tambah Kritik Saran</i></a>
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-border table-hover" name="kd_kritik">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Kritik dan Saran</th>
                    <th>Kode Anggota</th>
                    <th>Email</th>
                    <th>Tanggal</th>
            ...
            <tbody>
                <tr>
                  <?php
                    ...
                    $query=mysqli_query($host, $tampil) or die (mysqli_error($host));
                    while ($data = mysqli_fetch_array($query)){
                    ?>
                    <tr>
                      <th scope="row"><?=$no++?></th>
                      <td><?=$data['kd_kritik']?></td>
                      <td><?=$data['kd_anggota']?></td>
                      <td><?=$data['email']?></td>
                      <td><?=$data['tanggal']?></td>
                      <td><?=$data['kritiksaran']?></td>
                      <td>
                        <a href="delkritiksaran.php?kd_kritik=<?= $data['kd_kritik'] ?>" class="btn btn-danger btn-xs" onclick="return confrim('data yang dipilih akan terhapus')"> <i class="glyphicon glyphicon-trash"></i></a>
                      </td>
                      <td>
                        <a href="editkritiksaran.php?kd_kritik=<?= $data['kd_kritik'] ?>" class="btn btn-warning btn-xs" onclick="return confrim('data yang dipilih akan diedit')"> <i class="glyphicon glyphicon-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                    }
