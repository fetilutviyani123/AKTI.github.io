...
//$query = mysqli_query($host, "SELECT * FROM berita WHERE kd_berita= '$kd_berita' ");

//$query = mysqli_query($host, $sql);
$mysql_query = mysqli_query($host, "SELECT * FROM admin where kd_admin='$kd_admin'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="anggota.php"><i class="treeview-menu"></i>Admin</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseseditadmin.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <!-- <label for="kd_Admin">Kode Admin</label> -->
                        <input type="text" class="form-control hidden" name="kd_admin" value="<?php echo $data['kd_admin']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="username" value="<?php echo $data['username']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_pembina" value="<?php echo $data['nama_pembina']; ?>">
                      </div>
                      <div class="form-group">
                        <label>Kode Laporan</label>
                        <input type="text" class="form-control" name="kd_laporan" value="<?php echo $data['kd_laporan']; ?>">
                      </div>
