...
$mysql_query = mysqli_query($host, "SELECT * FROM anggota where kd_anggota='$kd_anggota'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="anggota.php"><i class="treeview-menu"></i>Anggota</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseseditanggota.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <!-- <label for="kd_berita">Kode Berita</label> -->
                        <input type="text" class="form-control hidden" name="kd_anggota" value="<?php echo $data['kd_anggota']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no_reg" value="<?php echo $data['no_reg']; ?>">
                      </div>
