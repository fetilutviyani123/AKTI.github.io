...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="kritiksaran.php"><i class="treeview-menu"></i>Kritik dan Saran</a></li>
        <li class="active">Tambah Kritik dan Saran</li>
      </ol>
    </section>
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Kritik dan Saran</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseskritiksaran.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <!-- <label for="kd_berita">Kode Berita</label> -->
                        <input type="text" class="form-control hidden" name="kd_kritik">
                      </div>
                      <div class="form-group">
                        <label>Kode Kritik dan Saran</label>
                        <input type="text" class="form-control" name="kd_kritik">
                      </div>
                      <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" class="form-control" name="kd_anggota">
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kritiksaran" >
