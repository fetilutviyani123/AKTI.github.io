...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jadwal Kegiatan
        <small>Tambah Jadwal Kegiatan</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Jadwal Kegiatan</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/prosesjadwalkegiatan.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                      <div class="form-group">
                        <label>Kode Jadwal</label>
                        <input type="text" class="form-control" name="kd_jadwal">
                      </div>
                      <div class="form-group">
