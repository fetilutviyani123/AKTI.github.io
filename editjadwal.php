...
//$query = "SELECT * FROM jadwal_kegiatan WHERE kd_jadwal=$data";
$mysql_query = mysqli_query($host, "SELECT * FROM jadwal_kegiatan where kd_jadwal='$kd_jadwal'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jadwal Kegiatan
        <small>Edit Jadwal Kegiatan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="berita.html"><i class="treeview-menu"></i>Jadwal Kegiatan</a></li>
        <li class="active">Edit Jadwal Kegiatan</li>
      </ol>
    </section>
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Edit Jadwal Kegiatan</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseseditjadwal.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                    <input type="text" class="form-control hidden" name="kd_jadwal" value="<?php echo $data['kd_jadwal']; ?>">
                      </div>
                      <div class="form-group">
                        <label>Alamat</label>
