  ...
  <div class="content-wrapper">
    ...
    <div class="box-body with-border">
      <div class="pull-right">
        <a href="tambahanggota.php" class="btn btn default btn-xs"><i class="glyphicon glyphicon-refresh">Tambah Anggota</i></a>
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-border table-hover" name="anggota">
        <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Anggota</th>
           ...
           <tbody>
               <?php
                ...
                <tr>
                  ...
                  <td><?=$data['no_reg']?></td>
                  <td>
                    <a href="delanggota.php?kd_anggota=<?= $data['kd_anggota'] ?>" class="btn btn-danger btn-xs" onclick="return confrim('data yang dipilih akan terhapus')"> <i class="glyphicon glyphicon-trash"></i></a>
                  </td>
                  <td>
                    <a href="editanggota.php?kd_anggota=<?= $data['kd_anggota'] ?>" class="btn btn-warning btn-xs" onclick="return confrim('data yang dipilih akan diedit')"> <i class="glyphicon glyphicon-edit"></i></a>
                  </td>
                </tr>
                <?php
                }
