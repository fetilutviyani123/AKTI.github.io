  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Jadwal Kegiatan</a></li>
      </ol>
    </section>
    ...
    <div class="box-body with-border">
      <div class="pull-right">
        <a href="tambahjadwalkegiatan.php" class="btn btn default btn-xs"><i class="glyphicon glyphicon-refresh">Tambah Jadwal Kegiatan</i></a>
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-border table-hover" name="jadwal_kegiatan">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode Jadwal</th>
             ...
             <tbody>
                <tr>
                  <?php
                    ...
                    $tampil="SELECT * FROM jadwal_kegiatan";
                    ...
                    <tr>
                      ...
                      <td><?=$data['no_hp']?></td>
                      <td>
                        <a href="deljadwal.php?kd_jadwal=<?= $data['kd_jadwal'] ?>" class="btn btn-danger btn-xs" onclick="return confrim('data yang dipilih akan terhapus')"> <i class="glyphicon glyphicon-trash"></i></a>
                      </td>
                      <td>
                        <a href="editjadwal.php?kd_jadwal=<?= $data['kd_jadwal'] ?>" class="btn btn-warning btn-xs" onclick="return confrim('data yang dipilih akan diedit')"> <i class="glyphicon glyphicon-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                    }
