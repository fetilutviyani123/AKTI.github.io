...
$mysql_query = mysqli_query($host, "SELECT * FROM berita where kd_berita='$kd_berita'");
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="./config/proseseditberita.php" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <!-- <label for="kd_berita">Kode Berita</label> -->
                        <input type="text" class="form-control hidden" name="kd_berita" value="<?php echo $data['kd_berita']; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="isi_berita" value="<?php echo $data['isi_berita']; ?>">
                    <div class="form-group">
                      <label for="exampleInputFile">Upload Gambar</label>
                      <input type="file" name="gambar" value="<?php echo $data['gambar']; ?>">
                      <p class="help-block">Simpan Perubahan?</p>
                    </div>
                    <div class="checkbox">
                      <label>
